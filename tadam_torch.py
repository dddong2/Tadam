    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            for p in group['params']:
                ...
                v.mul_(beta2).addcmul_(grad_p - h_hat, (grad_p - h_hat)*(beta2 - beta2**state['step'])/(1 - beta2**state['step']), value=(1 - beta2))
                ...
                fisher_information = (1.0 + torch.dot(torch.square(m_hat), 1/(v_hat + eps))) * v_hat
